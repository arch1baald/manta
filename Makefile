...
cover:
	go test -cover -coverpkg github.com/arch1baald/manta,github.com/arch1baald/manta/vbkv -coverprofile /tmp/manta.cov -v
...
update-protobufs:
	...
	$(SED) -i '1isyntax = "proto2";\n\npackage dota;\noption go_package = "github.com/arch1baald/manta/dota;dota";\n' dota/*.proto
